...
class Trainer:
    ...
    def _train(self, epoch,train_loader, optimizer):
        ...
        for data in train_loader:
            ...
            loss_n, loss_a = self.loss_fun(self.model.log_prob(inputs=samples))
            if epoch <= self.warmup:
                ...
                if self.train_method=='blind':
                    ...
                    if (torch.isnan(loss_mean) | torch.isinf(loss_mean)):
                        print(f'Deu ruim na época {epoch} ')
                        continue
    ...
    def detect_outliers(self, loader):
        ...
        return auc, ap, score_all,loss_in.item() / (target_all == 0).sum(), loss_out.item() / (target_all == 1).sum()
    ...
    def train(self, train_loader, contamination, query_num=0, optimizer=None, scheduler=None,
        ...
        if early_stopper is not None:
            ...
            if logger is not None:
                ...
                print(msg)
        return loss_list
        # return test_ap,test_f1, test_score
